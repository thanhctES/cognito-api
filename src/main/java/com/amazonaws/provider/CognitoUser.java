...
import com.amazonaws.provider.continuations.AuthenticationContinuation;
import com.amazonaws.provider.continuations.AuthenticationDetails;
import com.amazonaws.provider.continuations.ChallengeContinuation;
import com.amazonaws.provider.continuations.ChooseMfaContinuation;
import com.amazonaws.provider.continuations.ForgotPasswordContinuation;
import com.amazonaws.provider.continuations.MultiFactorAuthenticationContinuation;
import com.amazonaws.provider.continuations.NewPasswordContinuation;
import com.amazonaws.provider.continuations.RegisterMfaContinuation;
import com.amazonaws.provider.continuations.VerifyMfaContinuation;
import com.amazonaws.provider.exceptions.CognitoInternalErrorException;
...
import com.amazonaws.provider.handlers.DevicesHandler;
import com.amazonaws.provider.handlers.ForgotPasswordHandler;
import com.amazonaws.provider.handlers.GenericHandler;
import com.amazonaws.provider.handlers.GetDetailsHandler;
import com.amazonaws.provider.handlers.RegisterMfaHandler;
import com.amazonaws.provider.handlers.UpdateAttributesHandler;
import com.amazonaws.provider.handlers.VerificationHandler;
...
import com.amazonaws.provider.util.CognitoDeviceHelper;
import com.amazonaws.provider.util.CognitoSecretHash;
import com.amazonaws.provider.util.CognitoServiceConstants;
import com.amazonaws.provider.util.Hkdf;
import com.amazonaws.provider.continuations.CognitoIdentityProviderContinuation;
import com.amazonaws.services.AmazonCognitoIdentityProvider;
import com.amazonaws.services.model.AnalyticsMetadataType;
import com.amazonaws.services.model.AssociateSoftwareTokenRequest;
import com.amazonaws.services.model.AssociateSoftwareTokenResult;
import com.amazonaws.services.model.AttributeType;
import com.amazonaws.services.model.AuthenticationResultType;
import com.amazonaws.services.model.ChangePasswordRequest;
import com.amazonaws.services.model.CodeDeliveryDetailsType;
import com.amazonaws.services.model.ConfirmDeviceRequest;
import com.amazonaws.services.model.ConfirmDeviceResult;
import com.amazonaws.services.model.ConfirmForgotPasswordRequest;
import com.amazonaws.services.model.ConfirmSignUpRequest;
import com.amazonaws.services.model.DeleteUserAttributesRequest;
import com.amazonaws.services.model.DeleteUserRequest;
import com.amazonaws.services.model.DeviceSecretVerifierConfigType;
import com.amazonaws.services.model.DeviceType;
import com.amazonaws.services.model.ForgotPasswordRequest;
import com.amazonaws.services.model.ForgotPasswordResult;
import com.amazonaws.services.model.GetUserAttributeVerificationCodeRequest;
import com.amazonaws.services.model.GetUserAttributeVerificationCodeResult;
import com.amazonaws.services.model.GetUserRequest;
import com.amazonaws.services.model.GetUserResult;
import com.amazonaws.services.model.GlobalSignOutRequest;
import com.amazonaws.services.model.InitiateAuthRequest;
import com.amazonaws.services.model.InitiateAuthResult;
import com.amazonaws.services.model.InvalidParameterException;
import com.amazonaws.services.model.ListDevicesRequest;
import com.amazonaws.services.model.ListDevicesResult;
import com.amazonaws.services.model.NewDeviceMetadataType;
import com.amazonaws.services.model.NotAuthorizedException;
import com.amazonaws.services.model.ResendConfirmationCodeRequest;
import com.amazonaws.services.model.ResendConfirmationCodeResult;
import com.amazonaws.services.model.ResourceNotFoundException;
...
import com.amazonaws.services.model.SMSMfaSettingsType;
import com.amazonaws.services.model.SetUserMFAPreferenceRequest;
import com.amazonaws.services.model.SetUserMFAPreferenceResult;
import com.amazonaws.services.model.SetUserSettingsRequest;
import com.amazonaws.services.model.SetUserSettingsResult;
import com.amazonaws.services.model.SoftwareTokenMfaSettingsType;
import com.amazonaws.services.model.UpdateUserAttributesRequest;
import com.amazonaws.services.model.UpdateUserAttributesResult;
import com.amazonaws.services.model.UserContextDataType;
import com.amazonaws.services.model.VerifySoftwareTokenRequest;
import com.amazonaws.services.model.VerifySoftwareTokenResponseType;
import com.amazonaws.services.model.VerifySoftwareTokenResult;
import com.amazonaws.services.model.VerifyUserAttributeRequest;
import com.amazonaws.services.model.VerifyUserAttributeResult;
...
public class CognitoUser {
     ...
     * {@link CognitoIdentityProviderContinuation}
    ...
    public Runnable respondToChallenge(final RespondToAuthChallengeRequest challengeResponse,
        ...
        try {
            ...
            final CognitoUser cognitoUser = this;
            return getRunnableCognito(callback, runInBackground, rna, cognitoUser);
        } catch (final Exception e) {
            return new Runnable() {
                @Override
                public void run() {
    ...
    private Runnable getRunnableCognito(final AuthenticationHandler callback, final boolean runInBackground, final ResourceNotFoundException rna, final CognitoUser cognitoUser) {
    ...
    private InitiateAuthRequest initiateUserSrpAuthRequest(
        ...
        setClientMetadataValidation(authenticationDetails, initiateAuthRequest);
    ...
    private void setClientMetadataValidation(AuthenticationDetails authenticationDetails, InitiateAuthRequest initiateAuthRequest) {
    ...
    private InitiateAuthRequest initiateCustomAuthRequest(
        ...
        setClientMetadataValidation(authenticationDetails, authRequest);
