...
import com.amazonaws.services.model.*;
import com.amazonaws.services.model.transform.*;
...
public class AmazonCognitoIdentityProviderClient extends AmazonWebServiceClient implements
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/request.handler2s"));
    }
