...
/**
 * JSON unmarshaller for response VerifySoftwareTokenResult
 */
public class VerifySoftwareTokenResultJsonUnmarshaller implements
        Unmarshaller<VerifySoftwareTokenResult, JsonUnmarshallerContext> {
    ...
    public VerifySoftwareTokenResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Status")) {
                verifySoftwareTokenResult.setStatus(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Session")) {
                verifySoftwareTokenResult.setSession(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
