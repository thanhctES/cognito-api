...
import com.amazonaws.services.model.AdminListDevicesRequest;
...
/**
 * JSON request marshaller for AdminListDevicesRequest
 */
    ...
    public Request<AdminListDevicesRequest> marshall(AdminListDevicesRequest adminListDevicesRequest) {
        if (adminListDevicesRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(AdminListDevicesRequest)");
        }

        Request<AdminListDevicesRequest> request = new DefaultRequest<AdminListDevicesRequest>(
                adminListDevicesRequest, "AmazonCognitoIdentityProvider");
