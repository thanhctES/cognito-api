...
/**
 * JSON request marshaller for VerifySoftwareTokenRequest
 */
public class VerifySoftwareTokenRequestMarshaller implements
        Marshaller<Request<VerifySoftwareTokenRequest>, VerifySoftwareTokenRequest> {

    public Request<VerifySoftwareTokenRequest> marshall(
            VerifySoftwareTokenRequest verifySoftwareTokenRequest) {
        if (verifySoftwareTokenRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(VerifySoftwareTokenRequest)");
        }

        Request<VerifySoftwareTokenRequest> request = new DefaultRequest<VerifySoftwareTokenRequest>(
                verifySoftwareTokenRequest, "AmazonCognitoIdentityProvider");
