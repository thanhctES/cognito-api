...
import com.amazonaws.services.model.ListUsersResult;
import com.amazonaws.services.model.UserType;
    ...
    public ListUsersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Users")) {
                listUsersResult.setUsers(new ListUnmarshaller<UserType>(UserTypeJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("PaginationToken")) {
                listUsersResult.setPaginationToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
