...
import com.amazonaws.services.model.StringAttributeConstraintsType;
import com.amazonaws.transform.SimpleTypeJsonUnmarshallers.*;
import com.amazonaws.transform.*;
import com.amazonaws.util.json.AwsJsonReader;

/**
 * JSON unmarshaller for POJO StringAttributeConstraintsType
 */
class StringAttributeConstraintsTypeJsonUnmarshaller implements
    ...
    public StringAttributeConstraintsType unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("MinLength")) {
                stringAttributeConstraintsType.setMinLength(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("MaxLength")) {
                stringAttributeConstraintsType.setMaxLength(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
