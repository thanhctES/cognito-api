...
/**
 * JSON unmarshaller for response GetUserAttributeVerificationCodeResult
 */
public class GetUserAttributeVerificationCodeResultJsonUnmarshaller implements
        Unmarshaller<GetUserAttributeVerificationCodeResult, JsonUnmarshallerContext> {
