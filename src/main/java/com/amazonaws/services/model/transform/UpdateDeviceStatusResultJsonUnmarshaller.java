...
/**
 * JSON unmarshaller for response UpdateDeviceStatusResult
 */
public class UpdateDeviceStatusResultJsonUnmarshaller implements
        Unmarshaller<UpdateDeviceStatusResult, JsonUnmarshallerContext> {
