...
/**
 * JSON unmarshaller for POJO NewDeviceMetadataType
 */
class NewDeviceMetadataTypeJsonUnmarshaller implements
    ...
    public NewDeviceMetadataType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("DeviceKey")) {
                newDeviceMetadataType.setDeviceKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DeviceGroupKey")) {
                newDeviceMetadataType.setDeviceGroupKey(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
