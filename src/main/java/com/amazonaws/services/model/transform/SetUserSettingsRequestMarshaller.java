...
/**
 * JSON request marshaller for SetUserSettingsRequest
 */
    ...
    public Request<SetUserSettingsRequest> marshall(SetUserSettingsRequest setUserSettingsRequest) {
        if (setUserSettingsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(SetUserSettingsRequest)");
        }

        Request<SetUserSettingsRequest> request = new DefaultRequest<SetUserSettingsRequest>(
                setUserSettingsRequest, "AmazonCognitoIdentityProvider");
        ...
        try {
            ...
            if (setUserSettingsRequest.getMFAOptions() != null) {
                java.util.List<MFAOptionType> mFAOptions = setUserSettingsRequest.getMFAOptions();
