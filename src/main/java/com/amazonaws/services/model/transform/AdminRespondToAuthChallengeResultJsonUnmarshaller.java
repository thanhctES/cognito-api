...
import com.amazonaws.services.model.AdminRespondToAuthChallengeResult;
import com.amazonaws.transform.SimpleTypeJsonUnmarshallers.*;
import com.amazonaws.transform.*;
import com.amazonaws.util.json.AwsJsonReader;

/**
 * JSON unmarshaller for response AdminRespondToAuthChallengeResult
 */
public class AdminRespondToAuthChallengeResultJsonUnmarshaller implements
        Unmarshaller<AdminRespondToAuthChallengeResult, JsonUnmarshallerContext> {

    public AdminRespondToAuthChallengeResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChallengeName")) {
                adminRespondToAuthChallengeResult.setChallengeName(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Session")) {
                adminRespondToAuthChallengeResult.setSession(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ChallengeParameters")) {
                adminRespondToAuthChallengeResult
                        .setChallengeParameters(new MapUnmarshaller<String>(StringJsonUnmarshaller
                                .getInstance()
                        )
                                .unmarshall(context));
