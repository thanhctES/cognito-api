...
import com.amazonaws.services.model.AdminUserGlobalSignOutResult;
import com.amazonaws.transform.SimpleTypeJsonUnmarshallers.*;
import com.amazonaws.transform.*;
import com.amazonaws.util.json.AwsJsonReader;

/**
 * JSON unmarshaller for response AdminUserGlobalSignOutResult
 */
public class AdminUserGlobalSignOutResultJsonUnmarshaller implements
        Unmarshaller<AdminUserGlobalSignOutResult, JsonUnmarshallerContext> {

    public AdminUserGlobalSignOutResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
