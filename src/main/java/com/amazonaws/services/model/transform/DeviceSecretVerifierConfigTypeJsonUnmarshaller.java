...
/**
 * JSON unmarshaller for POJO DeviceSecretVerifierConfigType
 */
class DeviceSecretVerifierConfigTypeJsonUnmarshaller implements
        Unmarshaller<DeviceSecretVerifierConfigType, JsonUnmarshallerContext> {
    ...
    public DeviceSecretVerifierConfigType unmarshall(JsonUnmarshallerContext context)
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("PasswordVerifier")) {
                deviceSecretVerifierConfigType.setPasswordVerifier(StringJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else if (name.equals("Salt")) {
                deviceSecretVerifierConfigType.setSalt(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
