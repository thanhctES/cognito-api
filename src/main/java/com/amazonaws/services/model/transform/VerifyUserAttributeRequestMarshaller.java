...
/**
 * JSON request marshaller for VerifyUserAttributeRequest
 */
public class VerifyUserAttributeRequestMarshaller implements
    ...
    public Request<VerifyUserAttributeRequest> marshall(
        ...
        if (verifyUserAttributeRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(VerifyUserAttributeRequest)");
        }

        Request<VerifyUserAttributeRequest> request = new DefaultRequest<VerifyUserAttributeRequest>(
                verifyUserAttributeRequest, "AmazonCognitoIdentityProvider");
