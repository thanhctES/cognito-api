...
/**
 * JSON unmarshaller for response RespondToAuthChallengeResult
 */
public class RespondToAuthChallengeResultJsonUnmarshaller implements
        Unmarshaller<RespondToAuthChallengeResult, JsonUnmarshallerContext> {

    public RespondToAuthChallengeResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ChallengeName")) {
                respondToAuthChallengeResult.setChallengeName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Session")) {
                respondToAuthChallengeResult.setSession(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ChallengeParameters")) {
                respondToAuthChallengeResult.setChallengeParameters(new MapUnmarshaller<String>(
