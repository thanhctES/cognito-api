...
/**
 * JSON request marshaller for ForgotPasswordRequest
 */
    ...
    public Request<ForgotPasswordRequest> marshall(ForgotPasswordRequest forgotPasswordRequest) {
        if (forgotPasswordRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(ForgotPasswordRequest)");
        }

        Request<ForgotPasswordRequest> request = new DefaultRequest<ForgotPasswordRequest>(
                forgotPasswordRequest, "AmazonCognitoIdentityProvider");
