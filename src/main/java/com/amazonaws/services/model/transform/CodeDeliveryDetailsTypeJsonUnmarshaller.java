...
/**
 * JSON unmarshaller for POJO CodeDeliveryDetailsType
 */
class CodeDeliveryDetailsTypeJsonUnmarshaller implements
    ...
    public CodeDeliveryDetailsType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Destination")) {
                codeDeliveryDetailsType.setDestination(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("DeliveryMedium")) {
                codeDeliveryDetailsType.setDeliveryMedium(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("AttributeName")) {
                codeDeliveryDetailsType.setAttributeName(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
